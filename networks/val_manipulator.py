...
def exchanger(ori_raw, tar_raw, ori_raw_pre, tar_raw_pre, move_label):
    """
    :param q_pre_label:
    :param e_pre_label:
    :param t_label:
    ...
    return ori_raw, tar_raw, ori_pred_label, tar_pred_label_temp
...
def editor_ins(position_embedder, view_embedder, model_coarse, model_fine, ori_rays, tar_rays, args):
    """
...
def editor_test(position_embedder, view_embedder, model_coarse, model_fine, ori_poses, hwk, trans_dicts, save_dir,
